...
class UserController extends Controller
{
    ...
    public function downloadProfilePDF($userId){
        ...
        if(isset($userData->experience)){
            ...
            $text = isset($userData->experience->city) ? $userData->experience->city : "NA";
            $this->pdf->Text(70, 185, $text);

            $text = "Designation:";
            $this->pdf->Text(160, 185, $text);

            $text = isset($userData->experience->pincode) ? $userData->experience->pincode : "NA";
            ...
            $text = isset($userData->experience->country) ? $userData->experience->country : "NA";
