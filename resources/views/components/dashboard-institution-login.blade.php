        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="put-query-form">
                        @csrf
                        <div class="form-group">
                            <label for="put-query">Put your requirements here</label>
                            <textarea class="form-control" id="put-query" rows="8" placeholder="Put your requirements here ........................"></textarea>
                            <div class="put-query_error"></div>
                        </div>
                        <div class="form-group">
                            <label for="user_id"></label>
                            <input type="text" class="form-control" id="user_id" placeholder="user_id" value=" {{$data->user_id}}" hidden>
                        </div>
                        <button type="submit" class="btn btn-gradient-primary me-2" id="put-query-submit-button">Submit</button>
                    </form>
                </div>
            </div>
        </div>
