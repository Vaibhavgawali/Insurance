...
@section('main-section')
                     ...
                     <div style="margin: auto;" class="col-11 col-md-12 col-lg-7 shadow  rounded p-4 bg-white">
                       ...
                       <form method="POST" action="{{ route('candidate.store') }}">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="email"  name="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Tell us your Email ID">
                              @if($errors->has('email'))
                            ...
                            <div class="mb-3" id="experienceFields" style="display: none;">
                                ...
                                <div class="mb-3">
                                <label for="current-role" class="form-label">Current Role</label>
                                <input type="text" class="form-control"   name="designation" id="current-role" aria-describedby="current-roleHelp" placeholder="Whats Your Current Role?" >
                            ...
                            <div class="mb-3">
                                <select  class="form-control" name="preferred_line" aria-label="work status">
                             ...
                             <div class="d-flex align-items-center ">
                              ...
                              <div>
								<div>
									<button type="submit" class="btn btn-primary  my-2">Register Now</button>
								</div>
								Allready have an Account ? <a href="{{ route('login')}}" class="btn btn-secondary text-white mx-2">Login</a> 
							  </div>
                          </form>
                          <script>
    function validateForm() {
        ...
        if (name === '' || phone === '' || email === '' || password === '' || experience === '') {
